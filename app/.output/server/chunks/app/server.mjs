...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-1574027f.mjs').then((m) => m.default || m)
  }
];
